...
bg = pygame.transform.scale(pygame.image.load('background.png'), (WIDTH, HEIGHT)).convert_alpha()
bg_X1 = 0
bg_X2 = bg.get_width()
bg_move = 1

IMAGE_PATH = 'GooseAnimation'
PLAYER_IMAGES = os.listdir(IMAGE_PATH)

player = pygame.image.load('player.png').convert_alpha()
# player_rect = player.get_rect().move(100, HEIGHT // 2)
...
def create_enemy():
    enemy = pygame.transform.scale(pygame.image.load('enemy.png'), (110, 40)).convert_alpha()
...
def create_bonus():
    bonus = pygame.transform.scale(pygame.image.load('bonus.png'), (139, 258)).convert_alpha()
